        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <c:if test="${book.state==0}">
                    <td><a href="returnbook.html/<c:out value="${book.bookId}"></c:out>"><button type="button" class="btn btn-primary btn-xs">归还</button></a></td>
                </c:if>
                <td><a href="book_detail.html?bookId=<c:out value="${book.bookId}"></c:out>"><button type="button" class="btn btn-success btn-xs">详情</button></a></td>
